 ...
 * the License.
 */
package wicket.in.action.chapter01.section_1_1_2.listing04;
...
/**
 * The simplest form application possible. Just prints any user
 * input to a label.
 * 
...
public class Echo extends WebPage {
  ...
  public Echo() {
    ...
    // Add a form to change the message. We don't need to do
    // anything else with this form as the shared model is
    // automatically updated on form submits
